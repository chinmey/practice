...
string findSubString(string str, string pat)
{
    ...
    for (int j = 0; j < len1 ; j++)
    {
        ...
        if (count == len2)
        {
            ...
            while ( hash_str[str[start]] > hash_pat[str[start]] // for ex let pat be abn and window be aabbnn now we would check if either  string has more no of a or pattern has no a
