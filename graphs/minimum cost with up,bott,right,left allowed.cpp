...
if we are allowed to move only in right and bottom we can use dp see copy of dp notes  */
...
struct cell
{
	int x, y;
	int distance;
	cell(int x, int y, int distance) : /* can do without it simply doing  s.insert({a,b,d[a][b]})*/
